...
# def setup_module():
#     """Exécuté UNE SEULE FOIS avant tous les tests du module."""
#     print("\n🌱 [SETUP MODULE] Initialisation globale (ex: créer une base de données)")
#     # Exemple : Initialiser une connexion, préparer des données partagées
#     yield
#     # Ce code s'exécute APRES tous les tests (voir fixture ci-dessous)
