...
VALUES
    ...
    (1, N'Bouteille Eau', 8, 5, 0.50, 4.00),
    (2, N'Camembert', 1, 3, 2.70, 2.70),
    (2, N'Biscottes', 1, 4, NULL, 2.00),
    (2, N'Jus d''orange', 2, 9, 1.50, 3.00),
    (2, N'Barres chocolatées', 3, 6, NULL, 3.60), 
    (3, N'Poulet', 1, 2, 5.10, 5.10),
    (3, N'Pain', 2, 4, 1.20, 2.40),
    (4, N'Yaourt nature', 4, 3, 0.60, 2.40),
    (4, N'Compote', 2, 5, 0.75, 1.50),
    (5, N'Bière', 2, 9, 2.90, 5.80),
    (5, N'Pain de mie', 1, 4, NULL, 2.20),
    (6, N'Carottes', 3, 1, 0.90, 2.70),
    (6, N'Riz', 1, 4, 1.30, 1.30),
    (7, N'Vin rouge', 2, 9, 6.50, 13.00),
    (7, N'Glace', 2, 6, 2.10, 4.20),
    (7, N'Chips', 1, 4, NULL, 1.50),
    (8, N'Pommes', 5, 1, 0.80, 4.00),
    (9, N'Filet de poisson', 1, 2, 5.90, 5.90),
    (9, N'Pâtes', 2, 4, 1.20, 2.40),
    (9, N'Brioche', 1, 4, NULL, 2.10),
    (10, N'Yaourt nature', 6, 3, 0.50, 3.00),
    (10, N'Salade', 1, 1, 1.10, 1.10),
    (10, N'Tomates', 2, 1, 1.40, 2.80),
    (11, N'Poulet rôti', 2, 2, 9.90, 19.80),
    (11, N'Pain complet', 1, 4, 1.10, 1.10),
    ...
    (13, N'Bière', 2, 9, 1.90, 3.80),
    (14, N'Croissants', 3, 5, 0.90, 2.70),
    (14, N'Pain', 2, 4, 1.20, 2.40),
    (15, N'Beurre', 1, 3, 2.30, 2.30),
    (15, N'Rillettes', 2, 4, NULL, 4.50),
    (16, N'Chocolat', 2, 5, 1.00, 2.00),
    (16, N'Jus de pomme', 1, 9, NULL, 1.80);